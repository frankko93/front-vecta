...
export function setClientCookie(key: string, value: string, days = 7) {
  ...
  // biome-ignore lint/suspicious/noDocumentCookie: intentional cookie set for client auth
...
export function deleteClientCookie(key: string) {
  // biome-ignore lint/suspicious/noDocumentCookie: intentional cookie clear
